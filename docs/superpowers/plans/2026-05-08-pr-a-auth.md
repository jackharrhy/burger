...
export type AuthConfig = {
  fourmUrl: string;       // e.g. https://4orm.jackharrhy.dev
  burgerUrl: string;      // e.g. http://big.burger.beauty
...
services:
  burger:
    ...
    environment:
      ...
      - FOURM_URL=https://4orm.jackharrhy.dev
      - FOURM_CLIENT_ID=burger
      - BURGER_URL=http://big.burger.beauty
```
